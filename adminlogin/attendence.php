    ...
    <?= generateCalendar($month, $year); ?>
        ...
        <div class="sidebar">
            ...
            <li>
                ...
                <li>
                    <a href="../adminlogin/attendence.php" class="active">
