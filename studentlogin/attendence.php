    ...
    <?= generateCalendar($month, $year); ?>
        ...
        <div class="sidebar">
            ...
            <li>
                ...
                <li>
                    <a href="../studentlogin/attendence.php" class="active">
