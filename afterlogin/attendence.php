...
<div class="sidebar">
    ...
    if($num >=1){
            ...
            <ul>
                ...
                <li>
                    <a href="../afterlogin/attendence.php" class="active">
